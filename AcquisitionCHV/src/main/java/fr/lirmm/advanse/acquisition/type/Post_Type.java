...
public class Post_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.lirmm.advanse.acquisition.type.Post");
  ...
  public String getSubForum(int addr) {
      ...
      jcas.throwFeatMissing("SubForum", "fr.lirmm.advanse.acquisition.type.Post");
  ...
  public String getAuthor(int addr) {
      ...
      jcas.throwFeatMissing("Author", "fr.lirmm.advanse.acquisition.type.Post");
  ...
  public long getId(int addr) {
      ...
      jcas.throwFeatMissing("Id", "fr.lirmm.advanse.acquisition.type.Post");
  ...
  public String getThread(int addr) {
      ...
      jcas.throwFeatMissing("Thread", "fr.lirmm.advanse.acquisition.type.Post");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("Title", "fr.lirmm.advanse.acquisition.type.Post");
