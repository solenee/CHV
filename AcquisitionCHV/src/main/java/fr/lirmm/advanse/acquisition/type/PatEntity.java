 ...
 * @generated */
public class PatEntity extends BioEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PatEntity.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PatEntity() {/* intentionally empty block */}
   ...
   */
  public PatEntity(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PatEntity(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
