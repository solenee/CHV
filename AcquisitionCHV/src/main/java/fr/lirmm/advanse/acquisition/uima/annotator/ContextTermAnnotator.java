...
import fr.lirmm.advanse.acquisition.uima.model.api.IStopwords;
import fr.lirmm.advanse.acquisition.uima.model.impl.Stopwords;
...
public class ContextTermAnnotator extends JCasAnnotator_ImplBase {
	...
	public File stopwordsFile = new File("src/main/resources/stopwords/stopwords.csv");
