...
public class ContextTerm_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.lirmm.advanse.acquisition.type.ContextTerm");
  ...
  public String getNormalizedForm(int addr) {
      ...
      jcas.throwFeatMissing("NormalizedForm", "fr.lirmm.advanse.acquisition.type.ContextTerm");
