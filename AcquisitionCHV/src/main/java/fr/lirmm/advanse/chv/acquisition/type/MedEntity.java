...
public class MedEntity extends BioEntity {
  ...
  public final static int typeIndexID = JCasRegistry.register(MedEntity.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected MedEntity() {/* intentionally empty block */}
   ...
   */
  public MedEntity(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public MedEntity(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
