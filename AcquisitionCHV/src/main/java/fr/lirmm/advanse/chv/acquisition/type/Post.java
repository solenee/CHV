  ...
  */  
  ...
  public String getSubForum() {
    if (Post_Type.featOkTst && ((Post_Type)jcasType).casFeat_SubForum == null)
      jcasType.jcas.throwFeatMissing("SubForum", "fr.lirmm.advanse.chv.acquisition.type.Post");
  ...
  public String getAuthor() {
    if (Post_Type.featOkTst && ((Post_Type)jcasType).casFeat_Author == null)
      jcasType.jcas.throwFeatMissing("Author", "fr.lirmm.advanse.chv.acquisition.type.Post");
  ...
  public long getId() {
    if (Post_Type.featOkTst && ((Post_Type)jcasType).casFeat_Id == null)
      jcasType.jcas.throwFeatMissing("Id", "fr.lirmm.advanse.chv.acquisition.type.Post");
  ...
  public String getThread() {
    if (Post_Type.featOkTst && ((Post_Type)jcasType).casFeat_Thread == null)
      jcasType.jcas.throwFeatMissing("Thread", "fr.lirmm.advanse.chv.acquisition.type.Post");
  ...
  public String getTitle() {
    if (Post_Type.featOkTst && ((Post_Type)jcasType).casFeat_Title == null)
      jcasType.jcas.throwFeatMissing("Title", "fr.lirmm.advanse.chv.acquisition.type.Post");
